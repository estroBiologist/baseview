...
use winapi::um::winuser::{
    ...
    GetDpiForWindow, GetFocus, GetMessageW, GetParent, GetWindowLongPtrW, LoadCursorW,
    ...
    IDC_ARROW, MSG, SWP_NOMOVE, SWP_NOZORDER, TRACKMOUSEEVENT, WHEEL_DELTA, WM_CHAR, WM_CLOSE,
...
impl Window<'_> {
    ...
    pub fn defocus(&mut self) {
        unsafe {
            SetFocus(GetParent(self.state.hwnd));
        }
    }
